/**
 * Created by amidyshka on 14.06.15.
 */
/*
 *  Linkify - v1.1.6
...
!function (a, b, c) {
    ...
    var e = {tagName: "a", newLine: "\n", target: "_blank", linkClass: null, linkClasses: [], linkAttributes: null};
    d.prototype = {
        ...
        if (a && "object" == typeof a && 1 === a.nodeType && "a" !== a.tagName.toLowerCase() && !/[^\s]linkified[\s$]/.test(a.className)) {
            for (b = [], g = d._dummyElement || c.createElement("div"), e = a.firstChild, f = a.childElementCount; e;) {
                ...
                } else 1 === e.nodeType ? b.push(d.linkifyNode(e)) : b.push(e);
                e = e.nextSibling
            }
